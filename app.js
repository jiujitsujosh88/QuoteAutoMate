(() => {
  const App = {
    version: '0.3.1-kebab-i18n-fix',
    plan: 'lite',
    role: 'tech',
    lang: 'en',
    currency: { code:'USD', symbol:'$', locale:'en-US' },
    load(){
      try{ Object.assign(this, JSON.parse(localStorage.getItem('QAM_STATE') || '{}')); }
      catch(_){}
  ...
  function applyI18n(){
    ...
    const ariaMap = {
      'tab-quotes': 'tabs.quotes',
      'tab-history': 'tabs.history',
      'tab-customers': 'tabs.customers',
      'tab-presets': 'tabs.presets',
      'tab-analytics': 'tabs.analytics',
      'tab-settings': 'more.settings',
      'tab-business': 'more.business',
      'tab-resources': 'more.resources'
    };
  ...
  function renderSettings(){
    ...
    $('#save-settings').onclick = ()=>{
      try{
        ...
        App.currency = { code:$('#ccode').value.trim()||'USD', symbol:$('#csym').value.trim()||'$', locale:$('#cloc').value.trim()||'en-US' };
